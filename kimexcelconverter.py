...
def WriteRows(sheet, rowNum, dataRow):
    ...
    sheet.cell(row=rowNum, column=21).value = dataRow["FamilyPhone"] #"Parent Main Phone"
    sheet.cell(row=rowNum, column=22).value = "" #"Parent's Home Phone"
    sheet.cell(row=rowNum, column=23).value = dataRow["FamilyAddress1"] #"Street/Mailing Address"
    sheet.cell(row=rowNum, column=24).value = dataRow["FamilyCity"] #"Mailing City"
    sheet.cell(row=rowNum, column=25).value = "" #"Mailing State/Province"
    sheet.cell(row=rowNum, column=26).value = dataRow["FamilyZip"] #"Mailing Zip/Postal Code"


    sheet.cell(row=rowNum, column=27).value = dataRow["Parent2FirstName"] #"Second Parent's First Name"
    sheet.cell(row=rowNum, column=28).value = dataRow["Parent2LastName"] #"Second Parent's Last Name"
    sheet.cell(row=rowNum, column=29).value = dataRow["Parent2Gender"] #"Second Parent's Gender"
    sheet.cell(row=rowNum, column=30).value = dataRow["Parent2Language"] #"Parent's Preferred Language"
    sheet.cell(row=rowNum, column=31).value = dataRow["Family2Phone"] #"Second Parent's Phone"
    sheet.cell(row=rowNum, column=32).value = dataRow["Family2Address1"] #"Street/Mailing Address"
    sheet.cell(row=rowNum, column=33).value = dataRow["Family2City"] #"Mailing City"
    sheet.cell(row=rowNum, column=34).value = "" #"Mailing State/Province"
    sheet.cell(row=rowNum, column=35).value = dataRow["Family2Zip"] #"Mailing Zip/Postal Code"
...
def WriteHeader(sheet):
    ...
    sheet.cell(row=1, column=21).value = "Parent Main Phone"
    sheet.cell(row=1, column=22).value = "Parent's Home Phone"
    sheet.cell(row=1, column=23).value = "Street/Mailing Address"
    sheet.cell(row=1, column=24).value = "Mailing City"
    sheet.cell(row=1, column=25).value = "Mailing State/Province"
    sheet.cell(row=1, column=26).value = "Mailing Zip/Postal Code"
    sheet.cell(row=1, column=27).value = "Second Parent's First Name"
    sheet.cell(row=1, column=28).value = "Second Parent's Last Name"
    sheet.cell(row=1, column=29).value = "Second Parent's Gender"
    sheet.cell(row=1, column=30).value = "Parent's Preferred Language"
    sheet.cell(row=1, column=31).value = "Second Parent's Phone"
    sheet.cell(row=1, column=32).value = "Street/Mailing Address"
    sheet.cell(row=1, column=33).value = "Mailing City"
    sheet.cell(row=1, column=34).value = "Mailing State/Province"
    sheet.cell(row=1, column=35).value = "Mailing Zip/Postal Code"
